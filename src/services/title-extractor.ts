...
const EN_IMPERATIVE_RE =
  /\b(please\s+)?(send|share|submit|review|check|call|update|prepare|confirm|fill|upload|forward|reply|provide|schedule|fix|complete|attend|join|arrange|handle|ensure|verify|pay|approve|sign|read|complete)\b/i;
